...
# With parameters as of Mar 27:
# R_REPEL = 20.0. -->  vessel/mm^2
# R_REPEL = 30.0. --> 374 vessel/mm^2
# R_REPEL = 40.0. --> 373 vessel/mm^2
# R_REPEL = 50.0. --> 369 vessel/mm^2
# R_REPEL = 60.0. --> 347 vessel/mm^2
# R_REPEL = 70.0. --> 313 vessel/mm^2

R_REPEL = 20.0  # repulsive radius -->  vessels/mm^2
...
def save_as_grid(pts_um, filename, xDim=400, yDim=400, cell_size_um=10):
    """
